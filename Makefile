...
run:
		...
		docker node update --label-rm rabbitmq1 --label-rm consul demo1 || true
		docker node update --label-rm rabbitmq2 --label-rm consul demo2 || true
		docker node update --label-rm rabbitmq3 --label-rm consul demo3 || true
